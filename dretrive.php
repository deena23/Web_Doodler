            ...
            <div>
                <div>
                    <ul>
                        ...
                        <li><a href="finddoctors.php">Find Doctors</a></li>
                        <li><a href="retrive.php" style="color: rgba(12, 184, 182, 0.91);">Retrieve Medical Report</a></li>
...
$result = $conn->query($sql);
        ...
        while($row = $result->fetch_assoc())
            {
                echo "<tr><td>" . $row["Name"]. "</td><td>" . $row["Test"]. "</td><td>" . $row["Disease"].
